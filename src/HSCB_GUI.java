...
public class HSCB_GUI  {
	...
	Pane4 pane4 = new Pane4();
	Pane5 pane5 = new Pane5();
	Pane6 pane6 = new Pane6();
	Pane7 pane7 = new Pane7();

	protected JFrame frame = new JFrame("HSICB");
	...
	protected static class Pane1 extends JPanel {
	...
	protected class Pane3 extends JPanel {
		...
		JComboBox<String> radioConfigSel = new JComboBox<String>(radioConfigTypes);
	...
	protected class Pane4 extends JPanel {
		...
		JComboBox<String> routerConfigSel = new JComboBox<String>(routerConfigTypes);
	...
	protected class Pane5 extends JPanel {
		...
		JPasswordField mgmntWirelessEnPass = new JPasswordField();
	...
	protected class Pane7 extends JPanel {
		...
		JLabel uploadDirLabel = new JLabel("Directory:");
		
		JLabel uploadLocLabel = new JLabel("Upload Location:");
		 
		JTextField uploadHost = new JTextField(15);
		JTextField uploadUser = new JTextField(15);
		JTextField uploadDir = new JTextField(15);
		JPasswordField uploadPass = new JPasswordField(15);
		
		String[] UploadTypes = { "Powercode","SFTP","None" };
		JComboBox<String> UploadSel = new JComboBox<String>(UploadTypes);
		...
		public Pane7() {
			...
			okBut.addActionListener(new HSICB());
